...
"<datalist id=\"typeList\">" + "\n" +
    ...
    "<option value=\"BE\">BEP</option>" + "\n" +
    "<option value=\"BA\">Baccalauréat Général</option>" + "\n" +
    "<option value=\"BP\">Baccalauréat Professionnel</option>" + "\n" +
    "<option value=\"BS\">Baccalauréat Technologique</option>" + "\n" +
    "<option value=\"BT\">BTS</option>" + "\n" +
    "<option value=\"DU\">DUT</option>" + "\n" +
    "<option value=\"LC\">Licence</option>" + "\n" +
    "<option value=\"LP\">Licence Professionnel</option>" + "\n" +
    "<option value=\"DE\">DEES</option>" + "\n" +
    "<option value=\"MA\">Master</option>" + "\n" +
    "<option value=\"MB\">MBA</option>" + "\n" +
    "<option value=\"IN\">Diplôme d'Ingénieur</option>" + "\n" +
    "<option value=\"DR\">Doctorat</option>" + "\n" +
"</datalist>"
);

document.write(
"<datalist id=\"paysListe\">" + '\n' +
